...
providing an API to the rest of the application. The behavior you are building now is an extraordinarily simple behavior; however, behaviors can also be much more complex, such as Lists and Grids.
