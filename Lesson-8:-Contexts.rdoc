...
12. ((*[NOTE, an error in SDK versions 0.2.1 and below will cause this to fail. This will be fixed as of version 0.2.2]*)) Save, rebuild and run your application.
...
In the next lesson we will look more into Randori helper components with the {Randori ViewStack}[https://github.com/RandoriAS/randori-plugin-intellij/wiki/Lesson-9:-Dynamic-Loading-with-ViewStack].