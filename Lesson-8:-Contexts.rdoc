...
8. Override the configure() method of the GuiceModule class as shown below:
   ...
   The Binder instance passed to this method keeps track of the rules Guice uses to inject various 
   dependencies. You will start by asking Guice to make a substitution.
...
9. Inside this method, call the bind() method of the Binder instance, passing it the MessageGenerator class. 
   ...
   This asks Guice to substitute the BoringMessageGenerator for the original MessageGenerator anywhere it is   
