...
18. Assign the result of calling pushView() to a new variable of type Promise from the RANDORI library. 
    ...
    same name but in different packages. For example, JQuery also provides a promises implementation; however, 
    it is not necessarily compliant. Ensure you use the one from the Randori package.
