...
29. Finally, specify that we wish to show the name field from the data set the list will be provided
...
31. Override the onRegister() method so that we can provide some test data to the list:
