...
11. In your onRegister() method, below the existing code, add a click handler to the loadMore input using 
    JQuery.
    ...
    numerically but we will provide a superior naming convention shortly. ActionScript does not have method 
...
13. This provides an excellent opportunity to talk about cleanup. Just below your onRegister() method, 
